...
public class AppFlowDataHandler implements RequestHandler<Map<String, Object>, String> {
  ...
  public String handleRequest(Map<String, Object> event, final Context context) {
    ...
    String bucketName = (String) event.getOrDefault("Bucket", null);
    String key = (String) event.getOrDefault("Key", null);
